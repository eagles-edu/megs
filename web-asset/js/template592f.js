...
;(function () {
  class MobileNavigation {
    ...
    init() {
      ...
      // On desktop, mount nav immediately
    ...
    createMobileElements() {
      ...
      // Lazy-load sidebar menu content when needed
    ...
    openMenu() {
      ...
      // Ensure menu exists before opening on mobile
    ...
    handleResize() {
      if (!this.mediaQuery.matches && this.isOpen) this.closeMenu()
      // If switching to desktop, ensure nav is mounted
      if (!this.mediaQuery.matches) this.mountMenuIfNeeded()
    }
    ...
    mountMenuIfNeeded() {
      ...
      try {
        ...
        // Bind hover for newly inserted accordion items (similar to left-menu.js)
