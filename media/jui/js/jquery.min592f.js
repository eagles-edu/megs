...
!(function (e, t) {
  ...
  ;((p.fn = p.prototype =
    ...
    p.extend({
      ...
      makeArray: function (e, t) {
        ...
        return (
          null != e &&
            (y(Object(e)) ? p.merge(n, 'string' == typeof e ? [e] : e) : a.call(n, e)),
          n
        )
      },
      ...
      proxy: function (e, t) {
        var n, r, o
        if (('string' == typeof t && ((o = e[t]), (t = e), (e = o)), p.isFunction(e)))
          return (
  ...
  var x = (function (e) {
    ...
    function ie(e, t, r, i) {
      var o,
        ...
        C = t ? t.nodeType : 9
      if (
        ((r = r || []), 'string' != typeof e || !e || (1 !== C && 9 !== C && 11 !== C))
      )
        return r
    ...
    ;((n = ie.support = {}),
      ...
      (ie.uniqueSort = function (e) {
        var t,
          ...
          o = 0
        if (
          ((f = !n.detectDuplicates), (c = !n.sortStable && e.slice(0)), e.sort(S), f)
        ) {
            ...
            if (a) {
              ...
              for (; (t = t[r]); )
                if (1 === t.nodeType || i) {
                  if (
                    (s = (u =
                      (l = t[b] || (t[b] = {}))[t.uniqueID] || (l[t.uniqueID] = {}))[
                      r
                    ]) &&
                    s[0] === T &&
                    s[1] === o
    ...
    return (
            ...
            ;(m = k(
              ...
              (c = function (e, t, n, a, c) {
                ...
                if (((v += y), s && y !== v)) {
                  ...
                  ;(q.apply(a, b),
                    c && !e && b.length > 0 && v + o.length > 1 && ie.uniqueSort(a))
                }
                return (c && ((T = E), (l = w)), x)
              }),
              s ? ae(c) : c)
      ...
      (u = ie.select =
        function (e, t, i, o) {
          ...
          return (
            (p || s(e, h))(o, t, !g, i, !t || (Z.test(e) && pe(t.parentNode)) || t),
            i
          )
        }),
  ...
  function _() {
    r.addEventListener
      ? (r.removeEventListener('DOMContentLoaded', F), e.removeEventListener('load', F))
      : (r.detachEvent('onreadystatechange', F), e.detachEvent('onload', F))
  }
  function F() {
    ;(r.addEventListener || 'load' === e.event.type || 'complete' === r.readyState) &&
      (_(), p.ready())
  }
  ...
  var M,
    O = function (e) {
      var t = p.noData[(e.nodeName + ' ').toLowerCase()],
        n = +e.nodeType || 1
      return (
        (1 === n || 9 === n) && (!t || (!0 !== t && e.getAttribute('classid') === t))
      )
    },
    R = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
    P = /([A-Z])/g
      ...
      if ((c && l[c] && (i || l[c].data)) || void 0 !== r || 'string' != typeof t)
        return (
          ...
          ('object' != typeof t && 'function' != typeof t) ||
            (i ? (l[c] = p.extend(l[c], t)) : (l[c].data = p.extend(l[c].data, t))),
          (a = l[c]),
  ...
  function fe(e, t, n, r, i) {
    ...
    for (
      u && g.removeChild(u), f.appendChecked || p.grep(ae(m, 'input'), ce), v = 0;
      (a = m[v++]);
      ...
      if (
        ...
        for (h = 0; (u = g[h++]) && !t.isPropagationStopped(); )
          ((t.type = h > 1 ? l : f.bindType || m),
            (a = (p._data(u, 'events') || {})[t.type] && p._data(u, 'handle')) &&
              a.apply(u, n),
            (a = s && u[s]) &&
              a.apply &&
              O(u) &&
              ((t.result = a.apply(u, n)), !1 === t.result && t.preventDefault()))
        if (
          ((t.type = m),
          !o &&
        ...
        for (
          ...
          for (
            ...
            (e.rnamespace && !e.rnamespace.test(a.namespace)) ||
              ...
              (e.data = a.data),
              void 0 !==
                (r = ((p.event.special[a.origType] || {}).handle || a.handler).apply(
                  o.elem,
                  u
                )) &&
                !1 === (e.result = r) &&
  ...
  function _e(e, t, n, r) {
    ...
    if (
      ...
      for (s = (u = p.map(ae(c, 'script'), je)).length; d < h; d++)
        ((a = c),
          d !== g && ((a = p.clone(a, !0, !0)), s && p.merge(u, ae(a, 'script'))),
          n.call(e[d], a, d))
      if (s)
      ...
      function (e, t) {
        p.fn[e] = function (e) {
          for (var n, r = 0, i = [], o = p(e), s = o.length - 1; r <= s; r++)
            ((n = r === s ? this : this.clone(!0)), p(o[r])[t](n), a.apply(i, n.get()))
  ...
  function at(e, t, n) {
    ...
    if (i <= 0 || null == i) {
      if ((((i = Xe(e, t, o)) < 0 || null == i) && (i = e.style[t]), We.test(i)))
        return i
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          ...
          null != n &&
            n == n &&
            ('number' === o && (n += (i && i[3]) || (p.cssNumber[s] ? '' : 'px')),
            f.clearCloneStyle ||
              '' !== n ||
  ...
  ;(p.fn.extend({
    addClass: function (e) {
      ...
      if ('string' == typeof e && e)
        for (t = e.match(q) || []; (n = this[u++]); )
          if (
            ((i = Ht(n)), (r = 1 === n.nodeType && (' ' + i + ' ').replace(Lt, ' ')))
          ) {
    ...
    hasClass: function (e) {
      var t,
        ...
        r = 0
      for (t = ' ' + e + ' '; (n = this[r++]); )
        if (1 === n.nodeType && (' ' + Ht(n) + ' ').replace(Lt, ' ').indexOf(t) > -1)
          return !0
      return !1
    },
  }),
  ...
  ;(p.extend({
    ...
    ajax: function (t, n) {
      ...
      if (
        ...
        (T.success = T.done),
        (T.error = T.fail),
        (f.url = ((t || f.url || Ut) + '').replace(Ot, '').replace(Wt, Vt[1] + '//')),
        ...
        return T
      ;((u = p.event && f.global) && 0 == p.active++ && p.event.trigger('ajaxStart'),
        (f.type = f.type.toUpperCase()),
        (f.hasContent = !Bt.test(f.type)),
        (o = f.url),
        f.hasContent ||
          (f.data && ((o = f.url += (Ft.test(o) ? '&' : '?') + f.data), delete f.data),
          !1 === f.cache &&
            (f.url = Rt.test(o)
              ? o.replace(Rt, '$1_=' + _t++)
              : o + (Ft.test(o) ? '&' : '?') + '_=' + _t++)),
      ...
      function C(t, n, r, i) {
        ...
        2 !== b &&
          ...
          c
            ? (f.ifModified &&
                ((C = T.getResponseHeader('Last-Modified')) && (p.lastModified[o] = C),
  ...
  function nn(e, t, n, r) {
    ...
    if (p.isArray(t))
      p.each(t, function (t, i) {
        n || Kt.test(e)
          ? r(e, i)
          : nn(e + '[' + ('object' == typeof i && null != i ? t : '') + ']', i, n, r)
      })
      ...
      void 0 !== e.ActiveXObject
        ? function () {
            return this.isLocal
              ...
              : r.documentMode > 8
                ? sn()
                : (/^(get|post|head|put|delete|options)$/i.test(this.type) && sn()) ||
                  un()
          }
        : sn))
  var rn = 0,
              ...
              ;(a.send((t.hasContent && t.data) || null),
                (n = function (e, r) {
                  ...
                  if (n && (r || 4 === a.readyState))
                    if (
                      (delete on[s], (n = void 0), (a.onreadystatechange = p.noop), r)
                    )
